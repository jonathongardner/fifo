...
type Options struct {
	...
	Entropy   bool
	Filetype  bool
	CacheSize uint64 // use 0 for no cache
}
...
func NewOptions(md5, sha1, sha256, sha512, entropy, filetype bool, cacheSize uint64) Options {
	return Options{
		Md5:       md5,
		Sha1:      sha1,
		Sha256:    sha256,
...
func (o Options) UpdateCacheSize(size uint64) Options {
	o.CacheSize = size
	return o
}
